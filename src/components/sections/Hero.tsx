...
export default function Hero() {
    return (
        <section id="home" aria-labelledby="hero-heading" className="relative pt-32 pb-8 md:pt-40 md:pb-12 overflow-hidden">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
                    {/* Left side: Name, Title, Links */}
                    <div className="text-center md:text-left flex-1">
                        {/* Name */}
                        <h1 id="hero-heading" className="text-5xl md:text-6xl font-bold text-white mb-2">
                            {personalInfo.name}
                        </h1>
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                            <CalendlyButton
                                className="flex items-center gap-2 px-4 py-2 bg-green-400 text-gray-900 font-semibold rounded hover:bg-green-300 transition-all"
